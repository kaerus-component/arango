...
require.register("arango/lib/arango.js", function(module, exports, require) {
    ...
    function attach(db, api) {
        ...
        for (var ns in api) {
            if (!Object.getOwnPropertyDescriptor(db, ns)) load(db, ns, api[ns], true);
        }
    }
...
require.register("arango/lib/xhr.js", function(module, exports, require) {
    ...
    function reply(resolver, data, xhr) {
        ...
        if (!data) data = {
            code: xhr.status
        }; else if (typeof data === "object" && !data.code) data.code = xhr.status;
            ...
            create: function(graph, edgeDefinitions, vertexCollections, waitForSync) {
                ...
                if (edgeDefinitions && vertexCollections && typeof edgeDefinitions === "string" && typeof vertexCollections === "string") {
                    ...
                    if (typeof edgeDefinitions === "object") {
                        ...
                        if (typeof vertexCollections === "object") data.orphanCollections = vertexCollections; else if (typeof vertexCollections === "boolean") waitForSync = vertexCollections;
