...
var GraphAPI = {
    ...
    "edge": {
        ...
        "create": function(graph, edgeData, from, to, label, waitForSync, callback){
            ...
            return this.db.post(path+'/'+graph+'/edge'+optionsToUrl(options),data,callback);
        },
        /**
    ...
    "getEdgesForVertex": function(graph,vertex,options,callback){
        return this.db.post(path+"/" + graph+'/edges/'+vertex,options,callback);
    },
    /**
    ...
    "vertices": function(graph, options, callback){
        return this.db.post(path+"/" + graph+'/vertices/',options,callback);
    },
    /**
    ...
    "edges": function(graph,options,callback){
        return this.db.post(path+"/" + graph+'/edges/',options,callback);
    }
};
