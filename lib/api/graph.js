...
function GraphAPI(db) {
  ...
  return {
    ...
    "get": function (graph, callback) {
      return db.get(oldPath + '/' + graph, null, callback);
    },
    /**
    ...
    "list": function (callback) {
      return db.get(oldPath, callback);
    },
    /**
     * Deletes a graph
     *
    ...
    "delete": function (graph, waitForSync, callback) {
      ...
      return db.delete(oldPath + '/' + graph + optionsToUrl(this, options), null, callback);
    },
    "vertex": {
      /**
      ...
      "create": function (graph, vertexData, waitForSync, callback) {
        ...
        return db.post(oldPath + '/' + graph + '/vertex' + optionsToUrl(this, options), vertexData, callback);
      },
      ...
      "get": function (graph, id, options, callback) {
        ...
        return db.get(oldPath + '/' + graph + '/vertex/' + id + optionsToUrl(this, options), headers, callback);
      },
      /**
      ...
      "put": function (graph, id, data, options, callback) {
        ...
        return db.put(oldPath + '/' + graph + '/vertex/' + id + optionsToUrl(this, options), data, headers, callback);
      },
      /**
      ...
      "patch": function (graph, id, data, options, callback) {
        ...
        return db.patch(oldPath + '/' + graph + '/vertex/' + id + optionsToUrl(this, options, true), data, headers, callback);
      },
      /**
       * Deletes a vertex
       *
      ...
      "delete": function (graph, id, options, callback) {
        ...
        return db.delete(oldPath + '/' + graph + '/vertex/' + id + optionsToUrl(this, options), headers, callback);
      }
    },
    ...
    "edge": {
      ...
      "create": function (graph, edgeData, from, to, label, waitForSync, callback) {
        ...
        return db.post(oldPath + '/' + graph + '/edge' + optionsToUrl(this, options), data, callback);
      },
      /**
      ...
      "get": function (graph, id, options, callback) {
        ...
        return db.get(oldPath + '/' + graph + '/edge/' + id + optionsToUrl(this, options), headers, callback);
      },
      /**
      ...
      "put": function (graph, id, data, options, callback) {
        ...
        return db.put(oldPath + '/' + graph + '/edge/' + id + optionsToUrl(this, options), data, headers, callback);
      },
      /**
      ...
      "patch": function (graph, id, data, options, callback) {
        ...
        return db.patch(oldPath + '/' + graph + '/edge/' + id + optionsToUrl(this, options, true), data, headers, callback);
      },
      /**
       * Deletes an edge
       *
      ...
      "delete": function (graph, id, options, callback) {
        ...
        return db.delete(oldPath + '/' + graph + '/edge/' + id + optionsToUrl(this, options), headers, callback);
      }
    },
    /**
    ...
    "getNeighbourVertices": function (graph, vertex, options, callback) {
      ...
      return db.post(oldPath + "/" + graph + '/vertices/' + vertex, options, callback);
    },
    /**
    ...
    "getEdgesForVertex": function (graph, vertex, options, callback) {
      ...
      return db.post(oldPath + "/" + graph + '/edges/' + vertex, options, callback);
    },
    /**
    ...
    "vertices": function (graph, options, callback) {
      ...
      return db.post(oldPath + "/" + graph + '/vertices/', options, callback);
    },
    /**
    ...
    "edges": function (graph, options, callback) {
      ...
      return db.post(oldPath + "/" + graph + '/edges/', options, callback);
    },
    /**
