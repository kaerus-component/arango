...
function htmlOptions(options,o,keep){
    ...
    return Object.keys(o)
        .filter(function(k){return o[k] !== undefined;}).reduce(function(a,b,c){
            c = b + '=' + o[b];
            return !a ? '?' + c : a + '&' + c;
        },'');
}
...
var GraphAPI = {
    ...
    "get": function(graph,rev,callback){
        ...
        return this.db.get(path+graph+opts,callback);
    },
    ...
    "vertex": {
        "create": function(graph,vertex,options,callback){
            ...
            return this.db.post(path+graph+'/vertex',data,callback);
        },
        "get": function(graph,vertex,rev,callback){
            ...
            return this.db.get(path+graph+'/vertex/'+vertex+opts,callback);
        },
        "put": function(graph,vertex,options,rev,callback){
            ...
            return this.db.put(path+graph+'/vertex/'+vertex+opts,options,callback);
        },
        "patch": function(graph,vertex,options,rev,callback){
            ...
            return this.db.patch(path+graph+'/vertex/'+vertex+opts,options,callback);
        },
        "delete": function(graph,vertex,rev,callback){
            ...
            return this.db.delete(path+graph+'/vertex/'+vertex+opts,callback);
        }
    },
    "edge": {
        "create": function(graph,edge,from,to,options,callback){
            ...
            return this.db.post(path+graph+'/edge',data,callback);
        },
        "get": function(graph,edge,rev,callback){
            ...
            return this.db.get(path+graph+'/edge/'+edge+opts,callback);
        },
        "put": function(graph,edge,options,rev,callback){
            ...
            return this.db.put(path+graph+'/edge/'+edge+opts,options,callback);	
        },
        "patch": function(graph,edge,options,rev,callback){
            ...
            return this.db.patch(path+graph+'/edge/'+edge+opts,options,callback);
        },
        "delete": function(graph,edge,rev,callback){
            ...
            return this.db.delete(path+graph+'/edge/'+edge+opts,callback);
        }
    },
    "vertices": function(graph,vertex,options,callback){
        return this.db.post(path+graph+'/vertices/'+vertex,options,callback);
    },
    "edges": function(graph,edge,options,callback){
        return this.db.post(path+graph+'/edges/'+edge,options,callback);
    },
