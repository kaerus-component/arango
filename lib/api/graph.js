  ...
  return {
    ...
    "getNeighbourVertices": function (graph, vertex, options, callback) {
      ...
      switch (filter.direction) {
        case "in":
          bindVars.options.direction = "inbound";
          break;
        case "out":
          bindVars.options.direction = "outbound";
          break;
        case "any":
          bindVars.options.direction = "any";
          break;
        default:
      }
      ...
      if (filter.properties !== undefined) {
        filterQuery += process_properties_filter(bindVars, filter.properties, "u.path.edges[0]");
      }
      
      if (filter.labels !== undefined) {
        filterQuery += process_labels_filter(bindVars, filter.labels, "n.edge");
      }
      queryData.query += filterQuery;
    ...
    "getEdgesForVertex": function (graph, vertex, options, callback) {
      ...
      // Insert filters
      if (filter.properties !== undefined) {
        filterQuery += process_properties_filter(bindVars, filter.properties, "e");
      }
      
      if (filter.labels !== undefined) {
        filterQuery += process_labels_filter(bindVars, filter.labels, "e");
      }
      queryData.query += filterQuery;
