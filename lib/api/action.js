    ...
    var ActionAPI = {
        ...
        "define": function(o,f,reload) {
            ...
            function action() {
                ...
                console.log("submit action3", JSON.stringify(args));
        ...
        "submit": function() {
            ...
            console.log("submit args", JSON.stringify(args));
        ...
        "undefine": function(name) {
            ...
            if(!submit[name]) 
                ret.reject("No such action: " + name);

            if(submit[name].route) {
                db.document.delete(submit.route).then(function(res){
                    ret.fulfill(res);
                },function(error){
                    ret.reject("Failed to revoke action " + name + ": " + error);
                });
            } else ret.fulfill("undefined");    
