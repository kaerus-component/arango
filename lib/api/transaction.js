...
function TransactionAPI(db) {
    ...
    return {
         ...
         * @return{Promise}
         */
        "submit": function(collections, action, params, options, callback) {
            var transaction = {};
            ...
            transaction.action = action.toString();
            
            if(params) transaction.params = params;

            return db.post(path, transaction, options, callback);
        }
    }
}
