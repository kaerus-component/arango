...
var SimpleAPI = {
    ...
    "list": function(collection, options, callback) {
        ...
        return this.db.put(path+'all', applyOptions(this,data,options), callback);
    },
    /**
    ...
    "any": function(collection, callback) {
        ...
        var data = {collection:collection};
        return this.db.put(path+'any', data, callback);
    },
    /**
    ...
    "example": function(collection,example,options,callback) {
        ...
        return this.db.put(path+'by-example',applyOptions(this,data,options),callback);
    },
    /**
    ...
    "removeByExample": function(collection,example,options,callback) {
        ...
        var data = {collection:collection, example:example};
        return this.db.put(path+'remove-by-example',applyOptions(this,data,options),callback);
    },
    /**
    ...
    "replaceByExample": function(collection, example, newValue, options,callback) {
        ...
        var data = {collection:collection, example:example, newValue:newValue};
        return this.db.put(path+'replace-by-example',applyOptions(this,data,options),callback);
    },
    /**
    ...
    "updateByExample": function(collection, example, newValue, options,callback) {
        ...
        return this.db.put(path+'update-by-example',applyOptions(this,data,options),callback);
    },
    /**
    ...
    "firstByExample": function(collection,example,options,callback) {
        ...
        var data = {collection:collection, example:example}
        return this.db.put(path+'first-example',applyOptions(this,data,options),callback);
    },
    /**
    ...
    "first": function(collection, count, callback) {
        ...
        return this.db.put(path+'first',data,callback);
    },
    ...
    "last": function(collection, count, callback) {
        ...
        return this.db.put(path+'last',data,callback);
    },
    /**
    ...
    "range": function(collection, attribute, left, right, options, callback) {
        ...
        var data = {collection:collection, attribute : attribute,  left:left, right:right};
        return this.db.put(path+'range',applyOptions(this,data,options),callback);
    },
    /**
    ...
    "near": function(collection, latitude, longitude, options,callback) {
        ...
        var data = {collection:collection, latitude:latitude, longitude:longitude};
        return this.db.put(path+'near', applyOptions(this,data,options), callback);
    },
    /**
    ...
    "within": function(collection, latitude, longitude, radius, options,callback) {
        ...
        var data = {collection:collection, latitude:latitude, longitude:longitude, radius: radius};
        return this.db.put(path+'within',applyOptions(this,data,options),callback);
    },
    /**
    ...
    "fulltext": function(collection, attribute, query, options, callback){
        ...
        return this.db.put(path+'fulltext',applyOptions(this,data,options),callback);
    },
    "skip": function(val) {
        this._skip = val;
        return this;
