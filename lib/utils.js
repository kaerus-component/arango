...
function Params(args,func) {
    ...
    var params = "var i = 0; a = []; function params(){" + x + "return f.apply(this,a)}";

    return new Function("f",params + "return function(" +a.join(',')+ "){return params.apply(this,arguments)}")(func);
}
