        ...
        db.database.delete("newDatabase",function(err, ret){
            db.database.create("newDatabase",function(err, ret){
                ...
                db.collection.create("collection1", function(err,ret, message){
                    ...
                    db.import.importJSONData("collection2", data,  function(err,ret, message){
                        db.collection.create("collection2", function(err,ret, message){
                            var data = [{"_key":"Anton","value1":25,"value2":"test","allowed":true},
                                {"_key":"Bert","value1":"baz"},
                                {"_key":"Cindy","value1":"baaaz"},
                                {"_key":"Emil","value1":"batz"}
                            ];
                            db.import.importJSONData("collection1", data,  function(err,ret, message){
                                done();
                            });
                        });
                    });
