...
describe("graph",function(){
    ...
    describe("graphFunctions",function(){
        ...
        it('request all neighbouring edges of a vertex with batchsize 1 and count',function(done){
            db.graph.getEdgesForVertex("graph1", vertices[1]._id, {"batchSize" : 1, "count" : true}, function(err,ret, message){
                check( done, function () {
                    ret.error.should.equal(false);
        ...
        it('request all neighbouring edges of a vertex using filter direction',function(done){
            db.graph.getEdgesForVertex("graph1", vertices[1]._id, {"filter" : {"direction" : "in"}}, function(err,ret, message){
                check( done, function () {
                    ret.error.should.equal(false);
                    ret.result.length.should.equal(1);
                    ret.hasMore.should.equal(false);
        ...
        it('request all neighbouring edges of a vertex using filter properties',function(done){
            db.graph.getEdgesForVertex("graph1", vertices[1]._id, {"filter" : {"properties" :
            {"key": "key3" , "value" : "val3", "key- compare" : "="}}}, function(err,ret, message){
                check( done, function () {
                    ret.error.should.equal(false);
                    ret.result.length.should.equal(1);
                    ret.hasMore.should.equal(false);
        ...
        it('request all neighbouring vertices of a vertex with batchsize 1 and count',function(done){
            db.graph.getNeighbourVertices("graph1", vertices[1]._id, {"batchSize" : 1, "count" : true}, function(err,ret, message){
                check( done, function () {
                    ret.error.should.equal(false);
                    ret.result.length.should.equal(1);
                    ret.hasMore.should.equal(true);
        ...
        it('request all neighbouring vertices of a vertex using filter direction',function(done){
            db.graph.getNeighbourVertices("graph1", vertices[1]._id, {"filter" : {"direction" : "in"}}, function(err,ret, message){
                check( done, function () {
                    ret.error.should.equal(false);
                    ret.result.length.should.equal(1);
                    ret.hasMore.should.equal(false);
        ...
        it('request all neighbouring vertices of a vertex using filter properties',function(done){
            db.graph.getNeighbourVertices("graph1", vertices[1]._id, {"filter" : {"properties" :
            {"key": "key3" , "value" : "val3", "key- compare" : "="}}}, function(err,ret, message){
                check( done, function () {
                    ret.error.should.equal(false);
                    ret.result.length.should.equal(1);
        ...
        it('request all edges of a graph with batchsize 1 and count',function(done){
            db.graph.edges("graph1",  {"batchSize" : 1, "count" : true}, function(err,ret, message){
                check( done, function () {
                    ret.error.should.equal(false);
                    ret.result.length.should.equal(1);
                    ret.hasMore.should.equal(true);
        ...
        it('request all edges of a graph using filter properties',function(done){
            db.graph.edges("graph1",  {"filter" : {"properties" :
            {"key": "key3" , "value" : "val3", "key- compare" : "="}}}, function(err,ret, message){
                check( done, function () {
                    ret.error.should.equal(false);
                    ret.result.length.should.equal(1);
        ...
        it('request all vertices of a graph with batchsize 1 and count',function(done){
            db.graph.vertices("graph1",  {"batchSize" : 1, "count" : true}, function(err,ret, message){
                check( done, function () {
                    ret.error.should.equal(false);
                    ret.result.length.should.equal(1);
                    ret.hasMore.should.equal(true);
        ...
        it('request all vertices of a graph using filter properties',function(done){
            db.graph.vertices("graph1",  {"filter" : {"properties" :
            {"key": "key3" , "value" : "val4", "key- compare" : "="}}}, function(err,ret, message){
                check( done, function () {
                    ret.error.should.equal(false);
                    ret.result.length.should.equal(1);
                    ret.hasMore.should.equal(false);
        ...
        it('create a vertex',function(done){
            db.graph.vertex.create("graph1",  {"key1" : "val1", "key2" : "val2", "key3" : null}, false, function(err,ret, message){
                check( done, function () {
                    ret.error.should.equal(false);
        ...
        it('create a edge',function(done){
            db.graph.edge.create("graph1", {"key1" : "val1", "key2" : "val2", "key3" : null}, vertices[0]._id, vertices[1]._id, function(err,ret, message){
                check( done, function () {
                    edges = [];
                    ret.error.should.equal(false);
                    edges.push(ret.edge);
        ...
        it('create another edge',function(done){
            db.graph.edge.create("graph1",  {"key1" : "val1", "key3" : "val3"}, vertices[1]._id, vertices[2]._id, function(err,ret, message){
                check( done, function () {
                    edges.push(ret.edge)
                    ret.error.should.equal(false);
                    message.statusCode.should.equal(202);
        ...
        it('create another edge', function(done){
            db.graph.edge.create("graph1", {"key1" : "val1", "key2" : "val2"},   vertices[0]._id, vertices[1]._id, "a label", true, function(err,ret, message){
                check( done, function () {
                    edges.push(ret.edge)
                    ret.error.should.equal(false);
                    message.statusCode.should.equal(201);
